...
This document describes how to copy and customise the htwchur (bootstrapbase) theme so that
...
From your Moodle theme directory right click on htwchur and then copy and paste back
into your Moodle theme directory. You should now have a folder called Copy of htwchur.
...
underscores. For the purpose of this tutorial we will call the theme 'htwchurtheme'.
